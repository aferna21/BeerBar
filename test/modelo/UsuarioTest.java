...
public class UsuarioTest {
    ...
    public void testEscribirNotaA() throws BeerBarException {
        ...
        usuarioNormal.escribirNotaA(pedro, "Hola");
    ...
    public void testVerNotasHacia() throws BeerBarException{
        ...
        usuarioNormal.escribirNotaA(a, "hola Mundo");
    ...
    public void testVerNotasDe() throws BeerBarException{
        usuarioNormal.escribirNotaA(usuarioAdmin, "hola Mundo");
    ...
    public void testVerNotasRecibidas()throws BeerBarException{
        ...
        usuarioNormal.escribirNotaA(usuario1, "hola Mundo");
        usuarioNormal.escribirNotaA(usuario1, "hola A Secas");
        new Usuario("Adri", "admin", false).escribirNotaA(usuario1, "hola de Adri");
